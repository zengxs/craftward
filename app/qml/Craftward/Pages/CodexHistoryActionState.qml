...
QtObject {
    ...
    property bool forkReady
    property bool loadingThreads
    property bool loadingConversation
    property bool startingThread
    property bool forkingThread
    property bool turnInFlight
    property bool changingThreadLifecycle

    readonly property bool busy: loadingThreads || loadingConversation || startingThread || forkingThread || turnInFlight || changingThreadLifecycle
    ...
    readonly property bool canFork: hasSelection && forkReady && !archived && !busy
